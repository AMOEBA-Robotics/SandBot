...
//
//public class CallBackTask extends TimedTask {
//
...
//
//    public CallBackTask(
//            CallBackListener inListener, double position, long inDuration, String name) {
//        super(inDuration);
...
//                    telemetry.addData("Task: " + _name, "Executed");
//                }
//            }
//        } else {
//            if (!hasStarted) {
...
//                    (double) (System.currentTimeMillis() - _startTime) / (double) _duration;
...
//                telemetry.addData(
//                        "Task Step: " + percentComplete + " - " + _name,
//                        "Executed: " + String.valueOf(newPos));
//            }
//        }
//    }
//
